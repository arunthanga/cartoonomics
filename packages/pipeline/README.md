...
```text
src/cartoonomics/
├─ connectors/   # BaseConnector (polite fetch + provenance), robots (robots.txt policy), fixture, NSE/BSE, SEBI PMS (FR-1.2/1.3)
├─ parsing/      # PDF + delimited -> canonical ParsedFinancials; SEBI PMS report -> PmsMonthlyReport (FR-1.5)
